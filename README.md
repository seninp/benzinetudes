...
transcribed by hand. Data current through **2026-09-18**, built 2026-09-18.
...
![Map of France with the three cities marked](outputs/compare/figures/locator_map.png?v=33000a71)

| City | Stations (15 km) | Diesel €/L | vs France | 30 days | 12 months | At 2,250 € (30-day archive) | Fuel-pairs dry | Nearest 2,250 € pump |
|---|---:|---:|---:|---:|---:|---:|---:|---|
| [Castanet-Tolosan](#castanet) | 109 | **2.371** | -0.011 | +0.126 | +0.731 | 33.8% (24/71) | 57 (20.6%) | 8.8 km (Toulouse) |
| [Lyon](#lyon) | 237 | **2.398** | +0.016 | +0.137 | +0.742 | 27.6% (34/123) | 28 (6.3%) | 2.5 km (Lyon) |
| [Gentilly](#gentilly) | 659 | **2.402** | +0.020 | +0.129 | +0.668 | 40.0% (100/250) | 75 (8.5%) | 1.2 km (Paris) |

<sub>France mean diesel on 2026-09-18: **2.382 €/L**. "Fuel-pairs
...
![Diesel price history for the three cities against the French mean](outputs/compare/figures/diesel_history.png?v=6de55093)
...
![Share of diesel stations posting exactly the ceiling price, by city](outputs/compare/figures/ceiling_share.png?v=22818878)
...
![Share of station-fuel pairs flagged out of stock, by city](outputs/compare/figures/dry_share.png?v=22331cec)
...
**2.371 €/L** against a French mean of 2.382 —
+0.126 over 30 days, +0.731 over a year.
33.8% of its diesel stations posted exactly 2,250 €
within the last 30 days, and 57 station-fuel pairs
(20.6% of those active) are flagged dry.
The nearest pump posting the 2,250 € ceiling right now is 8.8 km away (10 Boulevard De Thibaud, Toulouse).

![Castanet-Tolosan: diesel and E10 price history against the French mean](outputs/castanet/figures/prices.png?v=870835ea)

![Castanet-Tolosan: map of stations within 15 km](outputs/castanet/figures/stations_map.png?v=4bfea293)
...
| 3.17 | TotalEnergies | 98 Avenue Tolosane, Ramonville Saint Agne | — | — | — | Gazole, SP98 |
| 3.27 | TotalEnergies | Centre Commercial De L'Autan, Labege | — | — | — | SP95, E10 |
...
**2.398 €/L** against a French mean of 2.382 —
+0.137 over 30 days, +0.742 over a year.
27.6% of its diesel stations posted exactly 2,250 €
within the last 30 days, and 28 station-fuel pairs
(6.3% of those active) are flagged dry.
The nearest pump posting the 2,250 € ceiling right now is 2.5 km away (100 Avenue Barthelemy Buyer, Lyon).

![Lyon: diesel and E10 price history against the French mean](outputs/lyon/figures/prices.png?v=5191bd3a)

![Lyon: map of stations within 15 km](outputs/lyon/figures/stations_map.png?v=857c6097)
...
**2.402 €/L** against a French mean of 2.382 —
+0.129 over 30 days, +0.668 over a year.
40.0% of its diesel stations posted exactly 2,250 €
within the last 30 days, and 75 station-fuel pairs
(8.5% of those active) are flagged dry.
The nearest pump posting the 2,250 € ceiling right now is 1.2 km away (27 Avenue De La Porte D'Italie, Paris).

![Gentilly: diesel and E10 price history against the French mean](outputs/gentilly/figures/prices.png?v=61d9d2e4)

![Gentilly: map of stations within 15 km](outputs/gentilly/figures/stations_map.png?v=8bbda897)
...
| 1.21 | TotalEnergies | 27 Avenue De La Porte D'Italie, Paris | **2.250** | **1.990** | — | GPLc |
| 1.36 | Avia | 91 Avenue Aristide Briand, Montrouge | 2.449 | 2.429 | 2.499 |  |
...
| 1.76 | TotalEnergies | 89 Av A. Briand, Arcueil | — | — | — | E10 |
| 2.21 | ? | Rue Legion Etrangere, Paris | — | **1.990** | **1.990** |  |
| 2.34 | Total Access | 181, Boulevard Vincent Auriol, Paris | **2.250** | **1.990** | **1.990** | SP98, E10 |
